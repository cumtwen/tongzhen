...
<body>
  <!--header-->
	<div class="header">
		...
		<div class="container">
			<div class="products">
					<h2 class=" products-in">最新童鞋</h2>
					<c:forEach items="${requestScope.shoes_list}" var="shoes" varStatus="stat">
						<div class="col-md-3 md-col" style="margin-bottom: 30px;">
							<div class="col-md">
								<a href="single?id=${shoes.id}" class="compare-in"><img  src="images/${shoes.img1 }.jpg" alt="" /></a>	
								<div class="top-content">
									<h5><a href="single?id=${shoes.id}">${shoes.name}</a></h5>
									<div class="white">
										<a href="single?id=${shoes.id}" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">页面详情</a>
										<p class="dollar">${shoes.price }</p>
										<div class="clearfix"></div>
									</div>
								</div>							
							</div>
