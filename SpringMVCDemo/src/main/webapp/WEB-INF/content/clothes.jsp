...
<body>
  <!--header-->
	<div class="header">
		...
		<div class="container">
			<div class="products">
					<h2 class=" products-in">童装上新</h2>
			<c:forEach items="${requestScope.clothes_list}" var="clothes" varStatus="stat">
						<div class="col-md-3 md-col" style="margin-bottom: 30px;">
							<div class="col-md">
								<a href="single?id=${clothes.id}" class="compare-in" }><img  src="images/${clothes.img1 }.jpg" alt="" /></a>	
								<div class="top-content">
									<h5><a href="single?id=${clothes.id}">${clothes.name }</a></h5>
									<div class="white">
										<a href="single?id=${clothes.id}" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">页面详情</a>
										<p class="dollar">${clothes.price}</p>
										<div class="clearfix"></div>
									</div>
								</div>							
							</div>
