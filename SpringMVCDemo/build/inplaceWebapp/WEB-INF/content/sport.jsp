...
<body>
  <!--header-->
	<div class="header">
		...
		<div class="container">
			<div class="products">
					<h2 class=" products-in">运动达人</h2>
					<c:forEach items="${requestScope.sport_list}" var="sport" varStatus="stat">
						<div class="col-md-3 md-col" style="margin-bottom:30px;">
							<div class="col-md">
								<a href="single?id=${sport.id}" class="compare-in"><img  src="images/${sport.img1 }.jpg" alt="" /></a>	
								<div class="top-content">
									<h5><a href="single?id=${sport.id}">${sport.name }</a></h5>
									<div class="white">
										<a href="single?id=${sport.id}" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">页面详情</a>
										<p class="dollar">${sport.price }</p>
										<div class="clearfix"></div>
									</div>
								</div>							
							</div>
